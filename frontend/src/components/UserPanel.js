    ...
    render() {
        ...
        return (
            ...
            <Grid columns='equal'>
                <Grid.Row>
                    <Grid.Column>
                        <div className={"backbutton"}><Button icon='left chevron' content={<Link to='/adminpanel'>Back</Link> }/> </div>
                    </Grid.Column>
                    <Grid.Column width={12}>
                        <p></p>
                        <Header textAlign={"center"}> Welcome to the user panel. </Header>
